...
/**
 * Entity representing a template of rule for food restriction.
 */
final class RestrictionRule
{
    private RestrictionRuleId $id;
    ...
    /**
     * Return the Id of The RestrictionRule.
     */
    public function getId(): RestrictionRuleId
    {
        return $this->id;
    }
    ...
    /**
     * Method to update the Severity of RestrictionRule.
     */
